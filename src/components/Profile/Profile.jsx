...
import {StatsList,StatsItem,StatsInfo,StatsOptions,Container,DescriptionContainer,UserImg ,UserName,UserDescribe}from "./Profile.styled"
export const Profile = ({ username = "vango", tag = "luke", location = "Kiev", avatar = defaultImage, stats }) => {
